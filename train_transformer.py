...
params = {
    ...
    #'i3d_frame_mask_feature_name': 'num_i3d_frames_mask',
    'use_subword_vocab': 'BERT', #'BERT', # 'True', 'False' or 'BERT'  # !
    'finetune': None,
    'use_augmentor_network': None, 
    'init_word_embedding':  '/path/to/bert/weight', #Can also be none to train from scratch.
...
if __name__ == "__main__":
    ...
    params['datasplit'] = os.path.basename(os.path.normpath(DATASET_PATH)) 
    ...
    if eval:
        num_eval_steps = (num_eval_samples // GLOBAL_BATCH_SIZE) + 1
    else:
